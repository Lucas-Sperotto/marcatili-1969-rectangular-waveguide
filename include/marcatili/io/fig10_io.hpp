...
/**
 * @brief Lê a configuração da reprodução da Fig. 10 a partir de um JSON textual.
 *
 ...
 *
 * @return Configuração preenchida para a reprodução da Fig. 10.
 *
 * @details
...
/**
 * @brief Constrói o relatório JSON de saída da reprodução da Fig. 10.
 */
...
/**
 * @brief Constrói o relatório CSV de saída da reprodução da Fig. 10.
 */
