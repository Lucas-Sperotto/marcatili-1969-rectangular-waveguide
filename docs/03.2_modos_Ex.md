...
![Figura 5 (b) — Guia imerso em diferentes dielétricos: distribuição de campo do modo fundamental (E^{x}_{11}).](img/fig_05.png)

Figura 5 (b) — Guia imerso em diferentes dielétricos: distribuição de campo do modo fundamental (E^{x}_{11}).
...
**Navegação:** [Anterior](03.1_modos_Ey.md) | [Índice](00_resumo.md) | [Checklist](09_checklist_reproducao.md) | [Roteiro](15_roteiro_de_estudo.md) | [Próximo](03.3_exemplos.md)
