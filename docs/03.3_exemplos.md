...
**Observacao de reproducao:** comparando os casos `a=b`, `a=2b` e `a=4b` com os cutoffs numericos obtidos a partir das familias da Fig. 6, o melhor acordo do repositorio atual e obtido interpretando o numero tabulado como a dimensao $a$, e nao como $b$. Para o caso quadrado essa distincao desaparece, mas para `a=2b` e `a=4b` ela e decisiva.
...
**Observacao de reproducao do repositorio:** a implementacao atual da Fig. 8 usa o conjunto modal de trabalho $E^{y}_{11}$, $E^{x}_{11}$ e $E^{x}_{21}$, que foi o melhor compromisso entre a leitura do scan e as equacoes atualmente transcritas. O relatorio `JSON` do caso-base registra explicitamente essa escolha, bem como o `TODO` de OCR para o rotulo intermediario.
...
**Navegação:** [Anterior](03.2_modos_Ex.md) | [Índice](00_resumo.md) | [Checklist](09_checklist_reproducao.md) | [Roteiro](15_roteiro_de_estudo.md) | [Riscos](23_riscos_tecnicos_e_pendencias.md) | [Próximo](04_acoplador_direcional.md)
