...
- O trecho é claramente qualitativo e perturbativo; aqui Marcatili não desenvolve uma expressão completa de ordem superior.
...
- Seção **V. Directional Coupler Made with Slightly Different Guides**;
- argumento perturbativo qualitativo para guias com pequenas diferenças de altura, largura ou índice de refração.
